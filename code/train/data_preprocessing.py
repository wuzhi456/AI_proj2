...
class DataPreprocessor:
    ...
    def downsample(self, X, y, random_state=42):
        ...
        Downsampling reduces the number of samples in the majority class to match
        the minority class, creating a balanced dataset for training.
        ...
        Returns:
            tuple: (X_balanced, y_balanced) - Balanced feature data and labels
        """
        ...
        class_counts = X_df['_label'].value_counts()
        majority_class = class_counts.idxmax()
        minority_class = class_counts.idxmin()
        
        majority_samples = X_df[X_df['_label'] == majority_class]
        minority_samples = X_df[X_df['_label'] == minority_class]
    ...
    def preprocess(self, train_df, train_labels, test_df, apply_downsampling=True, random_state=42):
        """
        ...
        Args:
            ...
            random_state (int): Random seed for downsampling
        ...
        # Apply downsampling to balance training data
        if apply_downsampling:
            X_train_scaled, train_labels = self.downsample(
                X_train_scaled, train_labels, random_state=random_state
            )
